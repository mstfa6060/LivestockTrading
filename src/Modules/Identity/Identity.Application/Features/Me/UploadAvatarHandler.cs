...
public sealed class UploadAvatarHandler : IConsumer<UploadAvatarCommand>
{
    private readonly IUserRepository _users;
    private readonly TimeProvider _clock;

    public UploadAvatarHandler(IUserRepository users, TimeProvider clock)
    {
        _users = users;
        _clock = clock;
    }
    ...
    public async Task Consume(ConsumeContext<UploadAvatarCommand> context)
    {
        ...
        try
        {
            ...
            user.SetAvatarUrl(context.Message.AvatarUrl, now);
