...
public sealed class RemoveDeviceHandler : IConsumer<RemoveDeviceCommand>
{
    private readonly IUserRepository _users;
    private readonly TimeProvider _clock;

    public RemoveDeviceHandler(IUserRepository users, TimeProvider clock)
    {
        _users = users;
        _clock = clock;
    }

    public async Task Consume(ConsumeContext<RemoveDeviceCommand> context)
    {
        ...
        try
        {
            ...
            user.RemoveDevice(context.Message.DeviceId, now);
