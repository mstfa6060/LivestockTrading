...
public static class ToggleLanguageActiveEndpoint
{
        ...
        CancellationToken ct)
    {
        ...
        var client = mediator.CreateRequestClient<ToggleLanguageActiveCommand>();

        var response = await client.GetResponse<Result>(
            new ToggleLanguageActiveCommand(id, request.Active, actorAdminId), ct);
