...
namespace LivestockTrading.Application.RequestHandlers.ProductVariants.Commands.Delete;
...
public class Verificator : IRequestVerificator
{
	...
	public async Task VerificateDomain(IRequestModel payload, EndpointContext context, CancellationToken cancellationToken)
	{
		...
		await _dbVerification.ValidateProductVariantExists(request.Id, cancellationToken);
	}
}
