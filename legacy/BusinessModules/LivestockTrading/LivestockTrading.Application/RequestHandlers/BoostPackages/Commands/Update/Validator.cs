...
public class Validator : IRequestValidator
{
	...
	{
		var request = (RequestModel)payload;
		await _dbValidator.ValidateBoostPackageExists(request.Id, cancellationToken);
	}
}
...
public class RequestModel_Validator : AbstractValidator<RequestModel>
{
	public RequestModel_Validator()
	{
		...
		RuleFor(x => x.Name)
			.NotEmpty()
			.WithMessage(ErrorCodeGenerator.GetErrorCode(() => LivestockTradingDomainErrors.BoostPackageErrors.BoostPackageNameRequired));
	}
}
