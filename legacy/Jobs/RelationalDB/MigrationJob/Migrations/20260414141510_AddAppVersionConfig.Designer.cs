...
namespace Jobs.RelationalDB.MigrationJob.Migrations
{
    ...
    [Migration("20260414141510_AddAppVersionConfig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Definitions.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 4, 14, 14, 15, 6, 240, DateTimeKind.Utc).AddTicks(5332),
                            IsDeleted = false,
                            IsSystemRole = true,
                            Name = "Admin",
                            UpdatedAt = new DateTime(2026, 4, 14, 14, 15, 6, 240, DateTimeKind.Utc).AddTicks(5976)
                        },
                        new
                        {
                            Id = new Guid("b3f8a7d1-4e2c-4a3e-8b5a-d3e7b9c5e2f1"),
                            CreatedAt = new DateTime(2026, 4, 14, 14, 15, 6, 240, DateTimeKind.Utc).AddTicks(6627),
                            IsDeleted = false,
                            IsSystemRole = true,
                            Name = "User",
                            UpdatedAt = new DateTime(2026, 4, 14, 14, 15, 6, 240, DateTimeKind.Utc).AddTicks(6628)
                        });
                });
            ...
            modelBuilder.Entity("Common.Definitions.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0f4da6f4-bee6-45b0-894d-e80bc09cf858"),
                            CreatedAt = new DateTime(2026, 4, 14, 14, 15, 6, 241, DateTimeKind.Utc).AddTicks(5910),
                            IsDeleted = false,
                            Permission = "ManageUsers",
                            RoleId = new Guid("a1d5b3e4-8e5a-4b3c-9ef5-d3e5a3b7c1f8"),
                            UpdatedAt = new DateTime(2026, 4, 14, 14, 15, 6, 241, DateTimeKind.Utc).AddTicks(5911)
                        },
                        new
                        {
                            Id = new Guid("52d09aa6-6c73-4460-a78e-813637c04793"),
                            CreatedAt = new DateTime(2026, 4, 14, 14, 15, 6, 241, DateTimeKind.Utc).AddTicks(5926),
                            IsDeleted = false,
                            Permission = "ManageRoles",
                            RoleId = new Guid("a1d5b3e4-8e5a-4b3c-9ef5-d3e5a3b7c1f8"),
                            UpdatedAt = new DateTime(2026, 4, 14, 14, 15, 6, 241, DateTimeKind.Utc).AddTicks(5926)
                        },
                        new
                        {
                            Id = new Guid("d6aa8ac3-5e34-4712-9961-9d01a0c427bc"),
                            CreatedAt = new DateTime(2026, 4, 14, 14, 15, 6, 241, DateTimeKind.Utc).AddTicks(5930),
                            IsDeleted = false,
                            Permission = "ViewListings",
                            RoleId = new Guid("b3f8a7d1-4e2c-4a3e-8b5a-d3e7b9c5e2f1"),
                            UpdatedAt = new DateTime(2026, 4, 14, 14, 15, 6, 241, DateTimeKind.Utc).AddTicks(5930)
                        });
                });
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.AnimalInfo", b =>
                {
                    ...
                    b.Property<double?>("AverageDailyEggProduction")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("DailyMilkProductionLiters")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.AppVersionConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.BoostPackage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.ContactForm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.Conversation", b =>
                {
                    ...
                    b.HasIndex("ParticipantUserId1");

                    b.HasIndex("ParticipantUserId2");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.Farm", b =>
                {
                    ...
                    b.Property<double?>("CultivatedAreaHectares")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.FeedInfo", b =>
                {
                    ...
                    b.Property<double?>("AshPercentage")
                        .HasColumnType("float");

                    b.Property<string>("BatchNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double?>("CalciumPercentage")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("EnergyKcalPerKg")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("FiberPercentage")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("MetabolizableEnergyMJPerKg")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("PhosphorusPercentage")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.IAPTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ProductBoostId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.MachineryInfo", b =>
                {
                    ...
                    b.Property<double?>("WorkingWidthCm")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.PaymentMethod", b =>
                {
                    ...
                    b.Property<double?>("FixedTransactionFee")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("TransactionFeePercentage")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("MediaBucketId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.ProductBoost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("IAPTransactionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.SeedInfo", b =>
                {
                    ...
                    b.Property<double?>("GerminationRate")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.SellerSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.SubscriptionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AppleProductIdMonthly")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("AppleProductIdYearly")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<string>("GoogleProductIdMonthly")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("GoogleProductIdYearly")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<bool>("HasDetailedAnalytics")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("MaxPhotosPerListing")
                        .HasColumnType("int");

                    b.Property<int>("MonthlyBoostCredits")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.IAPTransaction", b =>
                {
                    b.HasOne("LivestockTrading.Domain.Entities.SellerSubscription", "SellerSubscription")
                        .WithMany()
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.ProductBoost", b =>
                {
                    b.HasOne("LivestockTrading.Domain.Entities.BoostPackage", "BoostPackage")
                        .WithMany()
                        .HasForeignKey("BoostPackageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LivestockTrading.Domain.Entities.IAPTransaction", "IAPTransaction")
                        .WithMany()
                        .HasForeignKey("IAPTransactionId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.Seller", b =>
                {
                    b.HasOne("LivestockTrading.Domain.Entities.SellerSubscription", "ActiveSubscription")
                        .WithMany()
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.SellerSubscription", b =>
                {
                    ...
                    b.HasOne("LivestockTrading.Domain.Entities.SubscriptionPlan", "SubscriptionPlan")
