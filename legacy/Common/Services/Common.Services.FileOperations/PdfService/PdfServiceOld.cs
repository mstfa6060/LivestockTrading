...
public class PdfServiceOld
{
	...
	public PdfServiceOld(EnvironmentService environmentService)
	{
	...
	public byte[] AddedQrCode(byte[] fileContent, List<ReplacementItem> replacementData)
	{
		...
		var documentNumber = replacementData.FirstOrDefault(r => r.Key == "DOCUMENT_NUMBER").Values.FirstOrDefault();
