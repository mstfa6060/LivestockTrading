...
namespace LivestockTrading.Application.RequestHandlers.ChemicalInfos.Commands.Delete;
...
public class Verificator : IRequestVerificator
{
	...
	public async Task VerificateDomain(IRequestModel payload, EndpointContext context, CancellationToken cancellationToken)
	{
		...
		await _dbVerification.ValidateChemicalInfoExists(request.Id, cancellationToken);
	}
}
