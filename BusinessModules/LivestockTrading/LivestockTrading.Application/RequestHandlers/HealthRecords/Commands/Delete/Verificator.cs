...
namespace LivestockTrading.Application.RequestHandlers.HealthRecords.Commands.Delete;
...
public class Verificator : IRequestVerificator
{
	...
	public async Task VerificateActor(IRequestModel payload, EndpointContext context, CancellationToken cancellationToken)
	{
		...
		// Rol kontrolü: Seller, Veterinarian, Admin veya Moderator
		_permissionService.RequireAnyRole(
			Constants.LivestockTradingConstants.Roles.Seller,
			Constants.LivestockTradingConstants.Roles.Veterinarian,
	...
	public async Task VerificateDomain(IRequestModel payload, EndpointContext context, CancellationToken cancellationToken)
	{
		...
		await _dbVerification.ValidateHealthRecordExists(request.Id, cancellationToken);
	}
}
