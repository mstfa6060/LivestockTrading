...
namespace LivestockTrading.Application.RequestHandlers.ShippingZones.Commands.Delete;
...
public class Verificator : IRequestVerificator
{
	...
	public async Task VerificateDomain(IRequestModel payload, EndpointContext context, CancellationToken cancellationToken)
	{
		...
		await _dbVerification.ValidateShippingZoneExists(request.Id, cancellationToken);
	}
}
