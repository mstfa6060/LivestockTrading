...
namespace Jobs.RelationalDB.MigrationJob.Migrations
{
    ...
    [Migration("20260203205948_AddProductMediaFieldsAndSlugConstraint")]
    partial class AddProductMediaFieldsAndSlugConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Common.Definitions.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 3, 20, 59, 47, 163, DateTimeKind.Utc).AddTicks(4197),
                            IsDeleted = false,
                            IsSystemRole = true,
                            Name = "Admin",
                            UpdatedAt = new DateTime(2026, 2, 3, 20, 59, 47, 163, DateTimeKind.Utc).AddTicks(4201)
                        },
                        new
                        {
                            Id = new Guid("b3f8a7d1-4e2c-4a3e-8b5a-d3e7b9c5e2f1"),
                            CreatedAt = new DateTime(2026, 2, 3, 20, 59, 47, 163, DateTimeKind.Utc).AddTicks(4208),
                            IsDeleted = false,
                            IsSystemRole = true,
                            Name = "User",
                            UpdatedAt = new DateTime(2026, 2, 3, 20, 59, 47, 163, DateTimeKind.Utc).AddTicks(4208)
                        });
                });
            ...
            modelBuilder.Entity("Common.Definitions.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("63fbd10f-e4b9-41aa-b896-e66253002643"),
                            CreatedAt = new DateTime(2026, 2, 3, 20, 59, 47, 163, DateTimeKind.Utc).AddTicks(4393),
                            IsDeleted = false,
                            Permission = "ManageUsers",
                            RoleId = new Guid("a1d5b3e4-8e5a-4b3c-9ef5-d3e5a3b7c1f8"),
                            UpdatedAt = new DateTime(2026, 2, 3, 20, 59, 47, 163, DateTimeKind.Utc).AddTicks(4394)
                        },
                        new
                        {
                            Id = new Guid("9b187dae-42c2-4fcd-92b5-ee557bf6f664"),
                            CreatedAt = new DateTime(2026, 2, 3, 20, 59, 47, 163, DateTimeKind.Utc).AddTicks(4397),
                            IsDeleted = false,
                            Permission = "ManageRoles",
                            RoleId = new Guid("a1d5b3e4-8e5a-4b3c-9ef5-d3e5a3b7c1f8"),
                            UpdatedAt = new DateTime(2026, 2, 3, 20, 59, 47, 163, DateTimeKind.Utc).AddTicks(4398)
                        },
                        new
                        {
                            Id = new Guid("8c84b9ff-2b12-43ed-9f55-dd6a545e0b1f"),
                            CreatedAt = new DateTime(2026, 2, 3, 20, 59, 47, 163, DateTimeKind.Utc).AddTicks(4414),
                            IsDeleted = false,
                            Permission = "ViewListings",
                            RoleId = new Guid("b3f8a7d1-4e2c-4a3e-8b5a-d3e7b9c5e2f1"),
                            UpdatedAt = new DateTime(2026, 2, 3, 20, 59, 47, 163, DateTimeKind.Utc).AddTicks(4414)
                        });
                });
