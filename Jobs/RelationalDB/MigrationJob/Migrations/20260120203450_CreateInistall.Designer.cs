...
namespace Jobs.RelationalDB.MigrationJob.Migrations
{
    ...
    [Migration("20260120203450_CreateInistall")]
    partial class CreateInistall
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Common.Definitions.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 20, 20, 34, 49, 543, DateTimeKind.Utc).AddTicks(2116),
                            IsDeleted = false,
                            IsSystemRole = true,
                            Name = "Admin",
                            UpdatedAt = new DateTime(2026, 1, 20, 20, 34, 49, 543, DateTimeKind.Utc).AddTicks(2122)
                        },
                        new
                        {
                            Id = new Guid("b3f8a7d1-4e2c-4a3e-8b5a-d3e7b9c5e2f1"),
                            CreatedAt = new DateTime(2026, 1, 20, 20, 34, 49, 543, DateTimeKind.Utc).AddTicks(2132),
                            IsDeleted = false,
                            IsSystemRole = true,
                            Name = "User",
                            UpdatedAt = new DateTime(2026, 1, 20, 20, 34, 49, 543, DateTimeKind.Utc).AddTicks(2133)
                        });
                });
            ...
            modelBuilder.Entity("Common.Definitions.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c71c27f5-6784-45ee-834f-d2e7fa565f5e"),
                            CreatedAt = new DateTime(2026, 1, 20, 20, 34, 49, 543, DateTimeKind.Utc).AddTicks(2369),
                            IsDeleted = false,
                            Permission = "ManageUsers",
                            RoleId = new Guid("a1d5b3e4-8e5a-4b3c-9ef5-d3e5a3b7c1f8"),
                            UpdatedAt = new DateTime(2026, 1, 20, 20, 34, 49, 543, DateTimeKind.Utc).AddTicks(2370)
                        },
                        new
                        {
                            Id = new Guid("3c4d61be-465a-4df3-9b1f-33c153ca933f"),
                            CreatedAt = new DateTime(2026, 1, 20, 20, 34, 49, 543, DateTimeKind.Utc).AddTicks(2376),
                            IsDeleted = false,
                            Permission = "ManageRoles",
                            RoleId = new Guid("a1d5b3e4-8e5a-4b3c-9ef5-d3e5a3b7c1f8"),
                            UpdatedAt = new DateTime(2026, 1, 20, 20, 34, 49, 543, DateTimeKind.Utc).AddTicks(2377)
                        },
                        new
                        {
                            Id = new Guid("fc5b3784-dbb2-4828-b455-fabc539efe71"),
                            CreatedAt = new DateTime(2026, 1, 20, 20, 34, 49, 543, DateTimeKind.Utc).AddTicks(2418),
                            IsDeleted = false,
                            Permission = "ViewListings",
                            RoleId = new Guid("b3f8a7d1-4e2c-4a3e-8b5a-d3e7b9c5e2f1"),
                            UpdatedAt = new DateTime(2026, 1, 20, 20, 34, 49, 543, DateTimeKind.Utc).AddTicks(2419)
                        });
                });
