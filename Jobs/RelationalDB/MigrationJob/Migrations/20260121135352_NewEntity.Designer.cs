...
namespace Jobs.RelationalDB.MigrationJob.Migrations
{
    ...
    [Migration("20260121135352_NewEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Definitions.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 21, 13, 53, 49, 626, DateTimeKind.Utc).AddTicks(5190),
                            IsDeleted = false,
                            IsSystemRole = true,
                            Name = "Admin",
                            UpdatedAt = new DateTime(2026, 1, 21, 13, 53, 49, 626, DateTimeKind.Utc).AddTicks(5202)
                        },
                        new
                        {
                            Id = new Guid("b3f8a7d1-4e2c-4a3e-8b5a-d3e7b9c5e2f1"),
                            CreatedAt = new DateTime(2026, 1, 21, 13, 53, 49, 626, DateTimeKind.Utc).AddTicks(5215),
                            IsDeleted = false,
                            IsSystemRole = true,
                            Name = "User",
                            UpdatedAt = new DateTime(2026, 1, 21, 13, 53, 49, 626, DateTimeKind.Utc).AddTicks(5217)
                        });
                });
            ...
            modelBuilder.Entity("Common.Definitions.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f0303d45-7743-431c-9572-760c5f1ad719"),
                            CreatedAt = new DateTime(2026, 1, 21, 13, 53, 49, 626, DateTimeKind.Utc).AddTicks(5648),
                            IsDeleted = false,
                            Permission = "ManageUsers",
                            RoleId = new Guid("a1d5b3e4-8e5a-4b3c-9ef5-d3e5a3b7c1f8"),
                            UpdatedAt = new DateTime(2026, 1, 21, 13, 53, 49, 626, DateTimeKind.Utc).AddTicks(5650)
                        },
                        new
                        {
                            Id = new Guid("cc446f71-528d-456f-b478-713ce8f9822d"),
                            CreatedAt = new DateTime(2026, 1, 21, 13, 53, 49, 626, DateTimeKind.Utc).AddTicks(5661),
                            IsDeleted = false,
                            Permission = "ManageRoles",
                            RoleId = new Guid("a1d5b3e4-8e5a-4b3c-9ef5-d3e5a3b7c1f8"),
                            UpdatedAt = new DateTime(2026, 1, 21, 13, 53, 49, 626, DateTimeKind.Utc).AddTicks(5662)
                        },
                        new
                        {
                            Id = new Guid("d4d92239-a4a9-4125-a28b-855b82f31a2f"),
                            CreatedAt = new DateTime(2026, 1, 21, 13, 53, 49, 626, DateTimeKind.Utc).AddTicks(5697),
                            IsDeleted = false,
                            Permission = "ViewListings",
                            RoleId = new Guid("b3f8a7d1-4e2c-4a3e-8b5a-d3e7b9c5e2f1"),
                            UpdatedAt = new DateTime(2026, 1, 21, 13, 53, 49, 626, DateTimeKind.Utc).AddTicks(5698)
                        });
                });
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.OrderPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.OrderStatusHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.CartItem", b =>
                {
                    b.HasOne("LivestockTrading.Domain.Entities.Cart", "Cart")
                        .WithMany("Items")
                    ...
                    b.HasOne("LivestockTrading.Domain.Entities.ProductVariant", "ProductVariant")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.Order", b =>
                {
                    b.HasOne("LivestockTrading.Domain.Entities.Location", "BillingAddress")
                    ...
                    b.HasOne("LivestockTrading.Domain.Entities.Location", "ShippingAddress")
            ...
            modelBuilder.Entity("LivestockTrading.Domain.Entities.OrderItem", b =>
                {
                    b.HasOne("LivestockTrading.Domain.Entities.Order", "Order")
                        .WithMany("Items")
