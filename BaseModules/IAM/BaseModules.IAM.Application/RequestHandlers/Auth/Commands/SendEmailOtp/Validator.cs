...
public class RequestModel_Validator : AbstractValidator<RequestModel>
{
    public RequestModel_Validator()
    {
        RuleFor(x => x.Email)
            .NotEmpty()
            .WithMessage(ErrorCodeGenerator.GetErrorCode(() => DomainErrors.UserErrors.UserEmailRequired))
            .EmailAddress()
            .WithMessage(ErrorCodeGenerator.GetErrorCode(() => DomainErrors.UserErrors.UserEmailInvalid));
    }
}
